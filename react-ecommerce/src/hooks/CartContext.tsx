...
import type { CartAction, cartItem, CartState } from "../types/cartItems";
const temp = {
  id: 1,
...
const initialState: CartState = { cartItems: [], cartCount: 0 };

export const CartItemContext = createContext<CartState>(initialState);
...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <CartItemContext.Provider value={cartItemsState}>
